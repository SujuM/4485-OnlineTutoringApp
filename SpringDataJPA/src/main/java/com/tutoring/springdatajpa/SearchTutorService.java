...
//    }
//    public List<String> searchForSubjectsByFirstAndLastName(String firstName, String lastName)
//    {
//        Tutor tutor = tutorRepository.findByTutorFirstAndLastName(firstName, lastName);
